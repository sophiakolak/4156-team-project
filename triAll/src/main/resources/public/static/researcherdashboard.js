...
function noTrials() {
    ...
    expandBtn.append('<h5 class="cardHead"> You have no upcoming trials. Create one by clicking \"New Trial\".</h5>')
    ...
    cardBody.append('<div class = "medium"> What are you waiting for? Create a trial now. </div>')
    cardBody.append("<br>")
